...
import { getInvestorAccountPortfolio, getInvestmentDetails, investNowCancelAgreementAdmin, getUserAccountSummary, getMonthlyPaymentsToInvestorByOffering } from '../../queries/portfolio';
...
export class PortfolioStore {
  ...
  cancelAgreement = (agreementId, isAdmin = false) => {
    ...
    return new Promise((resolve, reject) => {
      client
        .mutate({
          mutation: investNowCancelAgreementAdmin,
          variables,
          refetchQueries: [{
            query: getInvestorAccountPortfolio,
