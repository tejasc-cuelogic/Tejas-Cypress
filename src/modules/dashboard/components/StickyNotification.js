    ...
    <div className="sticky-notification">
      <Card fluid raised>
        <Card.Content>
          ...
          <Button color="green" as={Link} floated="right" className="rounded pull-right" onClick={() => props.setDashboardWizardSetup(props.stepinfo.linkPath)} to="/app/dashboard">{props.stepinfo.linkText}</Button>
        </Card.Content>
      </Card>
    </div>
  </Responsive>
