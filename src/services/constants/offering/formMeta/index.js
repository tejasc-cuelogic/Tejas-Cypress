...
export const INVEST_NOW_TOC = FormHelper.generateMeta([
  ...
  ['account', 'Account', '', 'required', 'Account', {
    props: {
      options: [
...
export const INVEST_NOW_PAGE = FormHelper.generateMeta([
  ...
  ['hideHeader', 'Hide Header', [], 'optional', '', {
    props: {
      values: [
        {
          label: 'Hide Header',
...
export const INVEST_NOW_CONFIG_META = FormHelper.generateMeta([
  ['investmentType', 'Investment Type', 'DOLLARS', 'required', 'Investment Type', {
    props: {
  ...
  ['expectedReturnCalc', 'Expected Return Type', 'TERM_NOTE_CALCULATION', 'required', 'Investment Type', {
    props: {
  ...
  ['confirmationMessage', 'Confirmation Message', '', 'optional', 'Enter Here'],
  ['toggleConfirmation', '', [], 'optional', 'Enter here...', {
    asIn: true,
    props: {
      defaultValue: [],
      values: [{
        label: 'Hide confirmation referral',
        value: 'HIDE_REFERRAL',
      },
      {
        label: 'Hide confirmation header',
        value: 'HIDE_HEADER',
      }],
    },
  },
