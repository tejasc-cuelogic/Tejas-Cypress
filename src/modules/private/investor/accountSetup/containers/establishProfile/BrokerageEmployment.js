  ...
  render() {
    ...
    return (
      <>
        ...
        <Button basic data-cy="no-brokerage" onClick={() => { resetForm('BROKERAGE_EMPLOYMENT_FRM'); upsertInvestorProfile(multiSteps && multiSteps[stepToBeRendered]); }} fluid={isMobile} className={`${isMobile ? 'mb-20 relaxed' : ''} primary-hover`} content="No" />
