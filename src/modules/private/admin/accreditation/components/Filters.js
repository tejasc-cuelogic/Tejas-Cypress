        ...
        <Form>
          <Grid stackable>
            <Grid.Row>
              ...
              <Grid.Column width={3}>
                <DropdownFilter isMultiple value={requestState.search.city} name="Method" change={setSearchParam} options={FILTER_FRM.fields.method.values} />
              </Grid.Column>
              <Grid.Column width={3}>
                <DropdownFilter isMultiple value={requestState.search.city} name="Type" change={setSearchParam} options={FILTER_FRM.fields.type.values} />
              </Grid.Column>
            </Grid.Row>
          </Grid>
        </Form>
