    ...
    return (
      <Aux>
        ...
        <p className="center-align">
          ...
          <a target="_blank" rel="noopener noreferrer" href={`${window.location.origin}/education-center/for-investors/investment-limits-explained/investment-limit-calcuator/`} className="link">How is this calculated?</a>
        </p>
        <Form error>
