...
export default class GenerateDocs extends Component {
  ...
  render() {
    ...
    documentLists = securities === CAMPAIGN_KEYTERMS_SECURITIES_ENUM.REAL_ESTATE ? [...documentLists, 'llcAgreement', 'subscriptionAgreement', 'llcSpecialPurposeEntityAgreement'] : [...documentLists];
    return (
