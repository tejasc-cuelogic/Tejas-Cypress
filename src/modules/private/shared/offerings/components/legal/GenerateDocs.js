...
export default class GenerateDocs extends Component {
  ...
  generateDocList = (securities, equityClass) => {
    ...
    } else if (securities === CAMPAIGN_KEYTERMS_SECURITIES_ENUM.PREFERRED_EQUITY_506C || (securities === CAMPAIGN_KEYTERMS_SECURITIES_ENUM.EQUITY && ['PREFERRED', 'CLASS_A_SHARES', 'CLASS_B_SHARES', 'CLASS_B_SHARES'].includes(equityClass))) {
