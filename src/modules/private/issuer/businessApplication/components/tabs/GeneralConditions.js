...
In order to successfully launch your crowdfunding campaign, please be advised
    ...
    <List relaxed bulleted className="mt-40 mb-30">
      <List.Item>
        <List.Content>
          <b>Satisfactory Legal Diligence</b>
          {' '}
— you will need to provide certain background
      ...
      <List.Item>
        <List.Content>
          <b>Regulatory Filings</b>
          {' '}
— you will need to execute necessary regulatory
          documentation (Form ID, Form C, and any applicable state filings) with our assistance.
        </List.Content>
      </List.Item>
      <List.Item>
        <List.Content>
          <b>Escrow Documentation</b>
          {' '}
— you will need to execute documents required
          by our partner bank, GoldStar Trust Company.
        </List.Content>
      </List.Item>
      <List.Item>
        <List.Content>
          <b>Campaign Creation materials</b>
          {' '}
— you will need to provide the
      ...
      <List.Item>
        <List.Content>
          <b>Legally Required Disclosures under Reg CF</b>
          {' '}
— you will need to
