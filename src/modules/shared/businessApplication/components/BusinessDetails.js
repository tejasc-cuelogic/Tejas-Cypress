      ...
      <div className={hideFields ? 'inner-content-spacer' : 'ui container'}>
        <Form className="issuer-signup">
          ...
          <FormElementWrap
            ...
            subHeader={(
              <>
                {currentApplicationType === 'business' ? <>This document is intended to describe the who, what, when, where, how and why of your project.<br /> If you are applying for the Community Bridge Note, complete and submit <a href="https://nextseed.box.com/shared/static/cnru75v5lv5akiz5p7fap0d7nqljwuy9.pdf"><b>this worksheet</b></a> in addition to or in lieu of your business plan.*</> : 'Upload your Investment Summary or Business Plan.*'}
                    ...
                    <div className="field-wrap">
                      ...
                      <Form.Group widths="two">
                        ...
                        <FormDropDown
                          ...
                          options={options}
                          onChange={(e, result) => businessDetailsChange(e, result, 'debts', index)}
                        />
                      </Form.Group>
                    </div>
                  </Grid.Column>
