...
export const BUSINESS_APP_USER_STATUS = {
  PRE_QUALIFICATION_FAILED: {
    status: 'Not Eligible', icon: 'ns-offer-pending', color: 'orange', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  PRE_QUALIFICATION_SUCCESSFUL: {
    status: 'In-progress', icon: 'ns-offer-pending', color: 'orange', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  PRE_QUALIFICATION_SUBMITTED: {
    status: 'In-progress', icon: 'ns-check-circle-line', color: '', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  PRE_QUALIFICATION_PROMOTED: {
    status: 'Promoted', icon: 'ns-offer-pending', color: '', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  ...
  APPLICATION_REVIEWED: {
    status: 'Reviewed', icon: 'ns-offer-pending', color: '', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  APPLICATION_FAILED: {
    status: 'Failed', icon: 'ns-offer-pending', color: '', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  ...
  DECLINED: {
    status: 'Offer Declined', icon: 'ns-offer-declined', color: '', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  APPLICATION_DECLINED: {
    status: 'Offer Declined', icon: 'ns-offer-declined', color: '', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  APPLICATION_DELETED: {
    status: 'Deleted', icon: 'ns-offer-declined', color: '', dateTitle: 'Last Updated', datePath: 'updated.date',
  },
  ISSUER_DECLINED: {
...
export const BUSINESS_PRE_QUALIFICATION = {
  ...
  businessGoal: {
    value: '',
    values: [
      { label: <span>Pre-launch or<br />Pre-opening</span>, icon: 'ns-seed-icon', value: BUSINESS_GOAL.BRAND_NEW },
      { label: <span>Brand new business<br />(&lt;90 days)</span>, icon: 'ns-sprout-icon', value: BUSINESS_GOAL.UPGRADE },
      { label: <span>First year<br />of operations</span>, icon: 'ns-shrub-icon', value: BUSINESS_GOAL.BRAND_NEW },
      { label: <span>Over one year in business</span>, icon: 'ns-tree-icon', value: BUSINESS_GOAL.UPGRADE },
    ],
    error: undefined,
    rule: 'required',
    customErrors: { required: 'required' },
