...
const APPLICATION_TYPES_META = [
  ...
  {
    key: 'bo', icon: 'ns-business', text: 'Commercial Real Estate', value: 'business-real-estate', desc: 'Apply for real estate funding', to: '/business-application/business-real-estate',
  },
];
