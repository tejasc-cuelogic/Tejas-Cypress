...
<Card fluid key={application.applicationId}>
                  ...
                  <Card.Content>
                    <dl className="dl-horizontal">
                      ...
                      <dt>Started on</dt>
                      <dd>{application.created ? <DateTimeFormat isCSTFormat datetime={DataFormatter.getDateInLocalTimeZone(application.created.date, true, false, false)} /> : '--'}</dd>
                      <dt>{BUSINESS_APP_USER_STATUS[application.applicationStatus].dateTitle}</dt>
                      <dd>{(get(application, BUSINESS_APP_USER_STATUS[application.applicationStatus].datePath) || application.updated) ? <DateTimeFormat isCSTFormat datetime={(DataFormatter.getDateInLocalTimeZone((get(application, BUSINESS_APP_USER_STATUS[application.applicationStatus].datePath) || application.updated.date), true, false, false))} /> : '--'}</dd>
                    </dl>
