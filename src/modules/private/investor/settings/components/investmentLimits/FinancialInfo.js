                    ...
                    <Grid.Column computer={8} tablet={8} mobile={16}>
                      <Card.Content>
                        ...
                        <p className="intro-text">
                          ...
                          <Link target="_blank" to="/dashboard/resources/faq">See FAQ on investment limits</Link>
                        </p>
                        <Statistic size="tiny">
                          <Statistic.Label>
...
<Card.Content>
                          ...
                          <Link target="_blank" to="/dashboard/resources/knowledge-base/what-is-an-accredited-investor" className="intro-text highlight-text">What is an accredited investor?</Link>
                          <Divider hidden />
                          <Card.Description>
