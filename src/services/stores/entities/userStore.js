...
export class UserStore {
  ...
  @computed get getDeleteUserMeta() {
    ...
    if (this.confirmDelete) {
      ...
      data.message = (<><p className="mb-20">Thank you for being a part of the NextSeed community. <br /> If you change your mind, we'd love to have you back!</p><p className="mb-20">Please let us know if we can be of any help by contacting <br /> <a href="mailto:support@nextseed.com">support@nextseed.com</a>.</p></>);
      data.isValidForDelete = false;
