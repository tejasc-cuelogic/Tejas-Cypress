  ...
  render() {
    ...
    return (
      <>
        ...
        <Route path={`${match.url}/editPoc`} render={props => <EditPoc stage={offer.stage} refLink={`${match.url}/overview`} {...props} />} />
        <Route path={`${match.url}/editOffering`} render={props => <EditOffering refLink={`${match.url}/overview`} {...props} />} />
      </>
    );
  }
}
