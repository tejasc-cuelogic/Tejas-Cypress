...
const selectQuestionsOrEditInformation = props => (
  <Modal size="tiny" open closeIcon onClose={() => props.setDashboardWizardStep()}>
    <Modal.Header className="center-align signup-header">
      ...
      <Divider />
      <p>  You can either choose answer challege
      questions or go back and correct the
      submitted information.
      </p>
    </Modal.Header>
    <Modal.Content className="signup-content">
      <div className="center-align">
        <Button circular color="green" size="large" onClick={() => props.setDashboardWizardStep('ConfirmIdentityForm')}>Answer challenge questions</Button>
      </div>
      <div className="center-align">
