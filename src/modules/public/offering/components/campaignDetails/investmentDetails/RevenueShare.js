    ...
    return (
      <div className="campaign-about-wrapper investment-wrapper">
        ...
        <section>
          ...
          <List bulleted className="mb-30">
            <List.Item>Investment Multiple: 1.70x</List.Item>
            <List.Item>Monthly Revenue Sharing Percentage (first year): 4.0%</List.Item>
            <List.Item>Monthly Revenue Sharing Percentage (years 2–6): 4.0%</List.Item>
          </List>
          <p><b>Total Raise Amount: $400,100–$600,000</b></p>
          <List bulleted className="mb-30">
            <List.Item>Investment Multiple: 1.70x</List.Item>
            <List.Item>Monthly Revenue Sharing Percentage (first year): 4.0%</List.Item>
            <List.Item>Monthly Revenue Sharing Percentage (years 2–6): 7.0%</List.Item>
          </List>
          <p><b>Total Raise Amount: $600,100–$800,000</b></p>
          <List bulleted className="mb-30">
            <List.Item>Investment Multiple: 1.80x</List.Item>
            <List.Item>Monthly Revenue Sharing Percentage (first year): 4.0%</List.Item>
            <List.Item>Monthly Revenue Sharing Percentage (years 2–6): 10.25%</List.Item>
          </List>
          <p><b>Total Raise Amount: $800,100–$1,000,000</b></p>
          <List bulleted>
            <List.Item>Investment Multiple: 1.90x</List.Item>
            <List.Item>Monthly Revenue Sharing Percentage (first year): 4.0%</List.Item>
            <List.Item>Monthly Revenue Sharing Percentage (years 2–6): 13.5%</List.Item>
          </List>
          <p>
