...
export class NavStore {
  ...
  filterRoutes = (uKey, isMobile = false) => {
    ...
    navigationItems = navigationItems.filter(item => (item.title !== 'Setup' && (userDetailsStore.signupStatus.activeAccounts.length > 0 || userDetailsStore.signupStatus.partialAccounts.length > 0)));
