      ...
      <Table.Cell collapsing textAlign="center">
        <Button.Group vertical compact size="mini">
          {this.props.accreditation.verifier &&
            ...
            <Button loading={this.props.inProgress} onClick={() => this.props.emailVerifier(this.props.userId, this.props.accountId, this.props.accountType)} className="green" >Email Verifier </Button>
          }
