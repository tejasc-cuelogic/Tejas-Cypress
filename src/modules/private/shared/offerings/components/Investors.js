...
export default class BonusRewards extends Component {
  ...
  populateCsvData = () => {
    ...
    const fields = ['firstName', 'lastName', 'userEmail', 'street', 'streetTwo', 'city', 'state', 'zipCode', 'accountType', 'amount', 'autoDraftAmount', 'credit', 'investmentDate', 'investmentsCount', 'referralCode', 'earlyBirdEligibility', 'regulation', 'userId'];
    const params = {
      fields,
