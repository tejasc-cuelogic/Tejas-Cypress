...
export const PRODUCTION_REDIRECT_META = [
  ...
  { from: 'get20', live: true, to: '/how-it-works/investors?utm_source=invite&utm_medium=link&utm_campaign=saasquatch&rsCode=GET20&rsShareMedium=UNKNOWN&rsEngagementMedium=UNKNOWN' },
  { from: 'greenway', live: true, to: '/how-it-works/investors?utm_source=invite&utm_medium=link&utm_campaign=saasquatch&rsCode=GWAY&rsShareMedium=UNKNOWN&rsEngagementMedium=UNKNOWN' },
];

export const DEV_REDIRECT_META = [
  ...COMMON,
  { from: 'batmansucks', live: true, to: '/how-it-works/investors?utm_source=invite&utm_medium=link&utm_campaign=saasquatch&rsCode=BATMANSUCKS&rsShareMedium=UNKNOWN&rsEngagementMedium=UNKNOWN' },
];
