...
const CollectionMetaTags = ({ collection }) => (
  <Helmet>
    <meta name="description" content={DataFormatter.getOgDataFromSocial(get(collection, 'marketing.header.description'), 'facebook', 'blurb')} />
    ...
    <meta property="og:description" content={DataFormatter.getOgDataFromSocial(get(collection, 'marketing.social'), 'facebook', 'blurb')} />
    ...
    <meta property="og:image" content={DataFormatter.getOgDataFromSocial(get(collection, 'marketing.social'), 'facebook', 'featuredImageUpload.url')} />
    <meta property="og:image:secure_url" content={DataFormatter.getOgDataFromSocial(get(collection, 'marketing.social'), 'facebook', 'featuredImageUpload.url')} />
    <meta property="og:image:width" content="1218" />
    <meta property="og:image:height" content="542" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:description" content={DataFormatter.getOgDataFromSocial(get(collection, 'marketing.social'), 'twitter', 'blurb')} />
    <meta name="twitter:title" content={`${get(collection, 'marketing.header.title')} | NextSeed`} />
    <meta name="twitter:site" content="@thenextseed" />
    <meta name="twitter:image" content={DataFormatter.getOgDataFromSocial(get(collection, 'marketing.social'), 'twitter', 'featuredImageUpload.url')} />
