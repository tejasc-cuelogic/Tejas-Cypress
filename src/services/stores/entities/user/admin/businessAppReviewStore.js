...
export class BusinessAppReviewStore {
  ...
  maskChangeWithIndex = (values, form, arrayName = 'data', field, index) => {
    const fieldValue = ['companyInceptionDate', 'dateOfIncorporation', 'expirationDate', 'totalCapital', 'amount', 'minimumAmount', 'amortizationAmount'].includes(field) ? values.formattedValue : values.floatValue;
    this[form] = Validator.onArrayFieldChange(
      this[form],
