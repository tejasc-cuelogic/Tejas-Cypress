  ...
  render() {
    ...
    return (
      <div>
        ...
        <Route exact path={`${this.props.match.url}/verify-trust-entity-accreditation/verify/income`} component={IncomeAccreditation} />
        <Route exact path={`${this.props.match.url}/verify-trust-entity-accreditation/verify/assets`} component={AssetsAccreditation} />
