...
export default class AccountCreation extends React.Component {
  ...
  render() {
    const {
      isEnterPressed,
      resetIsEnterPressed,
      setIsEnterPressed, loaderMessage,
