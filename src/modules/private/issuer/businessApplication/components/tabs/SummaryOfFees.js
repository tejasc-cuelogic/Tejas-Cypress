...
We strive to be the biggest advocate of your business - NextSeed does not charge any
    ...
    <List relaxed bulleted className="mt-40 mb-30">
      <List.Item>
        <List.Content>
          <b>Escrow Account Setup</b>
          {' '}
— there is a one-time $500 fee payable to NextSeed
          {"'"}
s
            banking partner,
          <b className="primary-two-text">GoIdStar Trust Company</b>
          {' '}
to open an escrow account for you to
            receive investor
          {"'"}
s funds; and control persons. We perform a Bad Actor Check to
      ...
      <List.Item>
        <List.Content>
          ...
          {' '}
— (for the last two years, as applicable)
      ...
      <List.Item>
        <List.Content>
          ...
          {' '}
— professional photos, architecture renderings,
    ...
    <p>
Upon the successful closing of your campaign, we will settle NextSeed’s service fee with
    ...
    <List relaxed bulleted className="mt-40 mb-30">
      <List.Item>
        <List.Content>
          <b className="primary-two-text">0 Total § Raised &lt; $500K </b>
        : 5% of funds from Group A &amp; 10% of funds from Group B;
        </List.Content>
      </List.Item>
      <List.Item>
        <List.Content>
          <b className="primary-two-text">0 $500k 3 Total § Raised &lt; $750K </b>
        : 5% of funds from Group A &amp; 9% of funds from Group B; and
        </List.Content>
      </List.Item>
      <List.Item>
        <List.Content>
          <b className="primary-two-text">0 $750k 3 Total § Raised </b>
