    ...
    return (
      <Aux>
        ...
        {((pageMeta.subPanel === 1 || this.props.subNav) && !this.props.hideSubNav) &&
          <SecondaryMenu addon={this.props.subNavAddon} noinvert match={this.props.refMatch || this.props.match} attached="bottom" className="secondary-menu" navItems={pageMeta.subNavigations} stepsStatus={this.props.appStepsStatus} rightLabel={this.props.rightLabel} />
        }
        {this.props.P1 &&
