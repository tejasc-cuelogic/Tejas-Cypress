...
export const SIGNUP_REDIRECT_ROLEWISE = [{ role: 'admin', path: '/dashboard' }, { role: 'issuer', path: '/dashboard/business-application/new/pre-qualification' }, { role: 'investor', path: '/dashboard/summary/identity-verification/0' }];
