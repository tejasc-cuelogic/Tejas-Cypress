    ...
    return (
      <div>
        ...
        <p className="center-align mb-30">
          ...
          terms of the <Link to={this.props.history.url} className="link">CrowdPay Custodial Account Agreement</Link>, <Link to={this.props.history.url} className="link">Substitute IRS Form W-9 Certification</Link>,
          and the <Link to={this.props.history.url} className="link">NextSeed Membership Agreement</Link>.
        </p>
