...
const notificationPanel = (props) => {
  ...
  const NotificationActions = (
    <Dropdown icon="ns-ellipsis" pointing="right" className="icon pull-right">
      <Dropdown.Menu>
          ...
          <Aux key={item}>
            ...
            { _.map(Notifications[item], notification => (
              <div className="notification-box" key={notification.module}>
                ...
                {notification.money &&
                  <Button inverted size="small" primary className="link-button"><Icon name="ns-line-chart" />See full portfolio stats</Button>
                }
              </div>
            ))}
