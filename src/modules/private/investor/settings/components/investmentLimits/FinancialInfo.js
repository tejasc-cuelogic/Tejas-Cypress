...
import { EmptyDataSet, InlineLoader, PopUpModal, NsModal } from '../../../../../../theme/shared';
...
export default class FinancialInfo extends Component {
  ...
  handleVerifyAccreditationSteps = () => {
    ...
    if (this.props.userDetailsStore.isEntityTrust && accountSelectedType === 'entity') {
      ...
      this.props.history.push(`${this.props.match.url}/verify-accreditation/${accountSelectedType}`);
    }
  }
