    ...
    return (
      <Aux>
        ...
        {(pageMeta.subPanel === 1 || this.props.subNav) &&
          <SecondaryMenu noinvert match={this.props.match} attached="bottom" className="secondary-menu" navItems={pageMeta.subNavigations} stepsStatus={this.props.appStepsStatus} subNavComponent={this.props.subNavComponent} />
        }
