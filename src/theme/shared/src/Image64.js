...
class Image64 extends React.Component {
  state = { data: this.props.avatarPlaceholder ? emptyImage3 : this.props.imgType && this.props.imgType === 'heroImage' ? emptyImage2 : emptyImage1 };
  componentWillMount() {
    const emptyImage = this.props.avatarPlaceholder ? emptyImage3 : this.props.imgType && this.props.imgType === 'heroImage' ? emptyImage2 : emptyImage1;
