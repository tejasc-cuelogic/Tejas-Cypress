...
import { Modal, Button, Header, Form, Divider, Message, Dimmer, Loader, List, Grid } from 'semantic-ui-react';
  ...
  onSubmit,
    ...
    <Modal size="tiny" open closeIcon onClose={close} closeOnDimmerClick={false}>
      ...
      <Modal.Actions className="signup-actions">
        <p><Link to="/dashboard/summary">I’ll finish this later</Link></p>
      </Modal.Actions>
    </Modal>
));
