...
export default class failedAccreditation extends Component {
  render() {
    const { isAccreditationFlowInProgress } = this.props.accreditationStore; // accType
      ...
      >
        <Grid centered stackable className={isMobile ? 'full-width mt-0' : 'mt-0'}>
          <Grid.Column mobile={16} tablet={12} computer={8} className="pt-0">
            ...
            If your status changes to meet the criteria, please return to verify your status.
            </p>
