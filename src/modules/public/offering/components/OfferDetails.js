...
import { Grid, Header, Icon, Statistic, Menu, Label, Divider, Segment, Embed, Breadcrumb, Image, Popup } from 'semantic-ui-react';
                  ...
                  <Grid.Row>
                    <Grid.Column width={6}>
                      ...
                      <p className="detail-section">
                        Houston Brewery is expanding its facilities and launching the new Buffbrew
                        Taproom, complete with a full-service kitchen, event space and over 40
                        beers on tap.
                      </p>
                      <Divider />
                      <ul>
