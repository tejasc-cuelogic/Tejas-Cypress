...
export default class NewPhoneNumber extends Component {
  handleChangePhoneNumber = () => {
    this.props.history.replace(`${this.props.match.url}/confirm-phone-number`);
  }
  handleCloseModal = (e) => {
    e.stopPropagation();
  ...
  render() {
    ...
    return (
      <Modal size="mini" open closeIcon onClose={this.handleCloseModal}>
        <Route exact path={`${this.props.match.url}/confirm-phone-number`} component={ConfirmPhoneNumber} />
        ...
        <Modal.Content>
          <Form error onSubmit={this.handleChangePhoneNumber}>
            ...
            <div className="center-align">
              <Button as={Link} to={`${this.props.match.url}/confirm-phone-number`} loading={this.props.uiStore.inProgress} primary size="large" className="very relaxed">Change Phone Number</Button>
            </div>
          </Form>
        </Modal.Content>
      </Modal>
