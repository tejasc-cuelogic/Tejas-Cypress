                    ...
                    <Item>
                      <div className="ui image avatar-image">
                        {companyAvatarUrl && companyAvatarUrl.length
                          ...
                          : <UserAvatar UserInfo={{ firstName: dataItem.actingUserInfo.info.firstName, lastName: dataItem.actingUserInfo.info.lastName, avatarUrl: get(dataItem, 'actingUserInfo.info.avatar.url') || '' }} />
                      }
                      </div>
