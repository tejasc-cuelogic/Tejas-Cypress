...
const SortableItem = SortableElement(({
  ...
  <div className="row-wrap striped-table">
    ...
    <div className="balance width-250">
      Create: {get(offering, 'created.date') ? <DateTimeFormat isCSTFormat datetime={DataFormatter.getDateInCST(get(offering, 'created.date'), true, false, false)} /> : 'N/A'}<br />
      Launched: {get(offering, 'closureSummary.launchDate') ? <DateTimeFormat isCSTFormat datetime={DataFormatter.getDateInCST(get(offering, 'closureSummary.launchDate'), true, false, false)} /> : 'N/A'}<br />
      Closed: {get(offering, 'closureSummary.hardCloseDate') ? <DateTimeFormat isCSTFormat datetime={DataFormatter.getDateInCST(get(offering, 'closureSummary.hardCloseDate'), true, false, false)} /> : 'N/A'}
    </div>
