...
const GetBtn = ({ type }) => {
  ...
  return <Button disabled={!type} as={Link} to={type ? BtnMeta[type].to : '/auth/register'} secondary size="large" className="very relaxed" content={type ? BtnMeta[type].label : 'Open account'} />;
};
