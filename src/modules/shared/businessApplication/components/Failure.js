      ...
      <Grid container>
        <Grid.Column className="issuer-signup">
          ...
          <p>
            ...
            check out our <Link to="/how-it-works/business" className="link"><b>How it Works</b></Link> or <Link to="/resources/education-center/business" className="link"><b>Education Center </b></Link>
