...
,
                            ...
                            <Card.Content extra>
                              ...
                              <List divided horizontal>
                                ...
                                Raised
                                  {' '}
                                  {Helper.CurrencyFormat((get(offering, 'closureSummary.totalInvestmentAmount') || 0), 0)}
                                </List.Item>
                                <List.Item>
                                  {get(offering, 'closureSummary.totalInvestorCount') || 0}
                                  {' '}
investors
                                </List.Item>
                              </List>
